...
export class CreateRegistrations1777835728305 implements MigrationInterface {
    name = 'CreateRegistrations1777835728305'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "mfa_codes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "registrationId" uuid, CONSTRAINT "PK_0de25dd1c15cdffa23f403dee3a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "mfa_codes" ADD CONSTRAINT "FK_4d6dca6e4aaba1359d3ce6fbcec" FOREIGN KEY ("registrationId") REFERENCES "registrations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "mfa_codes" DROP CONSTRAINT "FK_4d6dca6e4aaba1359d3ce6fbcec"`);
        ...
        await queryRunner.query(`DROP TABLE "mfa_codes"`);
    }
